...
export const getMapTilesSettings = () => {
  ...
  /* defaults */
  const api = 'https://api.mapbox.com/styles/v1/trvrb/ciu03v244002o2in5hlm3q6w2/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaW5rdXptIiwiYSI6ImNrbmEzNm12ZjFkdWkybm54eDA0MXdmMjMifQ.l5ymcsrdrO-rOH97DUttaw';
  return {
    api,
