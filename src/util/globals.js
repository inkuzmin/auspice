...
export const getMapTilesSettings = () => {
  ...
  /* defaults */
  const api = 'https://api.mapbox.com/styles/v1/inkuzm/ckna46ep31z9p17o2kwv8xu7x/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaW5rdXptIiwiYSI6ImNrbmEzNm12ZjFkdWkybm54eDA0MXdmMjMifQ.l5ymcsrdrO-rOH97DUttaw';
  return {
    api,
